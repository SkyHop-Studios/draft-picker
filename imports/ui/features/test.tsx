...
const _initialValues: TestValues = {
  text: "",
  description: "",
  date: new Date(),
  type: "Option 1"
...
export type TestProviderProps = Omit<ComponentProps<typeof Formik<TestValues>>, "initialValues"> & {
  initialValues?: Partial<TestValues>
}

export const TestProvider = ({ initialValues, ...rest }: TestProviderProps) => {
  return <Formik
...
export namespace Inputs {
  ...
  export const TypeSelect = () => {
    const { setFieldValue, setFieldTouched } = useFormikContext<TestValues>();
    return <InputGroup>
